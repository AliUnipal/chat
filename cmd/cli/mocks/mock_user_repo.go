...
// GetUser provides a mock function for the type UserRepo
func (_mock *UserRepo) GetUser(ctx context.Context, id uuid.UUID) (userrepos.User, error) {
...
func (_c *UserRepo_GetUser_Call) Return(user userrepos.User, err error) *UserRepo_GetUser_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *UserRepo_GetUser_Call) RunAndReturn(run func(ctx context.Context, id uuid.UUID) (userrepos.User, error)) *UserRepo_GetUser_Call {
	_c.Call.Return(run)
	return _c
}
