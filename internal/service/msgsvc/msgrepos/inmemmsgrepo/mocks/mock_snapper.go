...
func (_mock *Snapper) Load(ctx context.Context) (msgrepos.Data, error) {
	...
	var r0 msgrepos.Data
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (msgrepos.Data, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) msgrepos.Data); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(msgrepos.Data)
		}
	}
...
func (_c *Snapper_Load_Call) Return(v msgrepos.Data, err error) *Snapper_Load_Call {
	_c.Call.Return(v, err)
	return _c
}

func (_c *Snapper_Load_Call) RunAndReturn(run func(ctx context.Context) (msgrepos.Data, error)) *Snapper_Load_Call {
	_c.Call.Return(run)
	return _c
}

// Snap provides a mock function for the type Snapper
func (_mock *Snapper) Snap(ctx context.Context, data msgrepos.Data) error {
...
func (_c *Snapper_Snap_Call) Run(run func(ctx context.Context, data msgrepos.Data)) *Snapper_Snap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 msgrepos.Data
		if args[1] != nil {
			arg1 = args[1].(msgrepos.Data)
		}
		run(
			arg0,
			arg1,
...
func (_c *Snapper_Snap_Call) RunAndReturn(run func(ctx context.Context, data msgrepos.Data) error) *Snapper_Snap_Call {
	_c.Call.Return(run)
	return _c
}
