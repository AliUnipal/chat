...
func (_mock *ChatService) CreateChat(ctx context.Context, ownerId uuid.UUID, participantId uuid.UUID) (uuid.UUID, error) {
	ret := _mock.Called(ctx, ownerId, participantId)
	...
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) (uuid.UUID, error)); ok {
		return returnFunc(ctx, ownerId, participantId)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, uuid.UUID, uuid.UUID) uuid.UUID); ok {
		r0 = returnFunc(ctx, ownerId, participantId)
	} else {
		if ret.Get(0) != nil {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, uuid.UUID, uuid.UUID) error); ok {
		r1 = returnFunc(ctx, ownerId, participantId)
	} else {
		r1 = ret.Error(1)
	}
	return r0, r1
...
func (_e *ChatService_Expecter) CreateChat(ctx interface{}, ownerId interface{}, participantId interface{}) *ChatService_CreateChat_Call {
	return &ChatService_CreateChat_Call{Call: _e.mock.On("CreateChat", ctx, ownerId, participantId)}
}

func (_c *ChatService_CreateChat_Call) Run(run func(ctx context.Context, ownerId uuid.UUID, participantId uuid.UUID)) *ChatService_CreateChat_Call {
...
func (_c *ChatService_CreateChat_Call) RunAndReturn(run func(ctx context.Context, ownerId uuid.UUID, participantId uuid.UUID) (uuid.UUID, error)) *ChatService_CreateChat_Call {
	_c.Call.Return(run)
	return _c
}

// GetChats provides a mock function for the type ChatService
func (_mock *ChatService) GetChats(ctx context.Context, userId uuid.UUID) ([]models.Chat, error) {
...
func (_c *ChatService_GetChats_Call) Return(Chats []models.Chat, err error) *ChatService_GetChats_Call {
	_c.Call.Return(Chats, err)
	return _c
}

func (_c *ChatService_GetChats_Call) RunAndReturn(run func(ctx context.Context, userId uuid.UUID) ([]models.Chat, error)) *ChatService_GetChats_Call {
	_c.Call.Return(run)
	return _c
}
