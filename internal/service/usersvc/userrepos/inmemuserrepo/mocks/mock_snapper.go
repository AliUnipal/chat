...
func (_mock *Snapper) Load(ctx context.Context) (userrepos.Data, error) {
	...
	var r0 userrepos.Data
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context) (userrepos.Data, error)); ok {
		return returnFunc(ctx)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context) userrepos.Data); ok {
		r0 = returnFunc(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(userrepos.Data)
		}
	}
...
func (_c *Snapper_Load_Call) Return(v userrepos.Data, err error) *Snapper_Load_Call {
	_c.Call.Return(v, err)
	return _c
}

func (_c *Snapper_Load_Call) RunAndReturn(run func(ctx context.Context) (userrepos.Data, error)) *Snapper_Load_Call {
	_c.Call.Return(run)
	return _c
}

// Snap provides a mock function for the type Snapper
func (_mock *Snapper) Snap(ctx context.Context, data userrepos.Data) error {
...
func (_c *Snapper_Snap_Call) Run(run func(ctx context.Context, data userrepos.Data)) *Snapper_Snap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 userrepos.Data
		if args[1] != nil {
			arg1 = args[1].(userrepos.Data)
		}
		run(
			arg0,
			arg1,
...
func (_c *Snapper_Snap_Call) RunAndReturn(run func(ctx context.Context, data userrepos.Data) error) *Snapper_Snap_Call {
	_c.Call.Return(run)
	return _c
}
