...
-- +goose Up
<<<<<<<< HEAD:internal/migrations/20251013120226_create_chat_table.sql
========
CREATE TABLE users
(
    id         UUID PRIMARY KEY,
...
>>>>>>>> 13bec8b (Some cleanup and SQL migration fixes.):internal/migrations/20251013120058_create_chat_table.sql
